...
public class DangNhap extends javax.swing.JFrame {
    ...
    public DangNhap() {
        initComponents();
        this.setBounds(600, 180, this.getWidth(),this.getHeight());
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tendangnhap, javax.swing.GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)
...
//                    JOptionPane.showMessageDialog(this,"mật khẩu không đúng");
             ...
             if(flag==1)
          {
                ...
                else if(chucvu.equalsIgnoreCase("thungan"))
                        {
                            Giaodienchinh giaodien=new Giaodienchinh();
                            giaodien.setVisible(true);
                            giaodien.thungan();
                        }
                else if(chucvu.equalsIgnoreCase("thukho"))
                        {
                            Giaodienchinh giaodien=new Giaodienchinh();
                            giaodien.setVisible(true);
                            giaodien.thukho();
